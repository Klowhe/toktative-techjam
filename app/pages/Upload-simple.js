        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <div style="display: flex; gap: 0; align-items: center; position: relative;">
            <div style="display: flex; flex-direction: column; align-items: center; position: relative; height: 60px; justify-content: center; width: 100px;">
              <button onclick="navigateTo('/upload')" style="padding: 0.75rem 1.5rem; background: transparent; color: white; border: none; cursor: pointer; font-size: 0.875rem; width: 100%;">Upload</button>
              <div style="width: 50%; height: 4px; background: #009995; border-radius: 2px; position: absolute; bottom: 8px;"></div>
            </div>
            <div style="display: flex; flex-direction: column; align-items: center; position: relative; height: 60px; justify-content: center; width: 100px;">
              <button onclick="navigateTo('/features')" style="padding: 0.75rem 1.5rem; background: transparent; color: #88898a; border: none; cursor: pointer; font-size: 0.875rem; width: 100%;">Features</button>
            </div>
